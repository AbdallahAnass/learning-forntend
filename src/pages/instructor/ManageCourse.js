...
// Sections:
//   1. Course info card — thumbnail, title, description, skills (all inline-editable)
//   2. Publish / Delete actions
//   3. Course Content — collapsible module/lesson tree with reorder, upload, quiz edit
//   4. Student Reviews — read-only list with aggregate rating
                      ...
                      {mod.lessons.map((lesson) => {
                        ...
                        return (
                          <div key={lesson.id} className="flex items-center gap-3 px-14 py-2.5 border-b border-border/40 last:border-0 hover:bg-secondary/30 transition-colors group/lesson">
                            ...
                            {/* AI indexing status badge (only for non-quiz lessons) */}
                            ...
                            {/* ── File actions for video / PDF lessons ─────── */}
                            {lesson.content_type !== "quiz" && (
                              <>
